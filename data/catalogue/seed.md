...
|---|---|---|---|---|---|---|---|---|---|---|
| D3 | 2026-08-29, 16:45 | **LCI**, presenter Darius Rochebin, from the 3rd summer university of the Laboratoire de la République (Jean-Michel Blanquer), Sens (Yonne); title "France 2027, quelles perspectives ?" | TV (news channel), simulcast TF1 Info, LCI YouTube and X | Édouard Philippe (declared), François Hollande (undeclared; says he will decide in December 2026) | 1 h 16 min 16 s (`sp-2F_cTTxA`, read 2026-09-06) | LCI YouTube `https://www.youtube.com/watch?v=sp-2F_cTTxA` ("Le débat entre Édouard Philippe et François Hollande｜LCI", published 2026-08-29, `playableInEmbed:true`) | Download and embed: LCI copy `sp-2F_cTTxA` | `tolerated` | No | Hollande is not a Candidate |
| D4 | 2026-09-02, 19:00–20:30 | **Libération** ("Libé 2027", first public meeting), Académie du Climat, Paris, before 250 citizens; moderated by Sonia Delesalle-Stolper and Thomas Legrand; carried live by BFM2 and the BFM app | Newspaper's own live stream (Twitch, YouTube) plus BFM2 | François Ruffin (united-left primary contender), Dominique de Villepin (undeclared) | 2 h 18 min 53 s (`D7vTQp2iM00`, live archive incl. pre-show, read 2026-09-06) | Libération YouTube `https://www.youtube.com/watch?v=D7vTQp2iM00` ("«Libé 2027» : suivez François Ruffin et Dominique de Villepin en débat", live archive published 2026-09-02, `playableInEmbed:true`) | Download and embed: Libération copy `D7vTQp2iM00`; other carrier BFM2 / BFM app (RMC+) | `tolerated (to check)`: Libération's CGU and tdmrep not yet inventoried in `source-terms.md` | No for YouTube; BFM2 replay via RMC+ needs an account | Neither participant is a declared Candidate; Ruffin runs in the united-left primary |
...
| Xavier Bertrand | 2026-08-27 | MEDEF REF (stage), reported by LCP and franceinfo | Panel "La solidarité inconditionnelle, jusqu'à quand ?" (with J.-P. Farandou, T. Buberl, S. Boissard, G. Cette, C. Thieffinne; moderator David Abiker); the only `@MEDEFtv` upload with him (#28) | In-room | 47 min 48 s | MEDEF `@MEDEFtv` `https://www.youtube.com/watch?v=56T7EQm-sMs` (published 2026-08-27, embeddable) | MEDEF copy `56T7EQm-sMs` | `mining-exception` (organiser's own channel; YouTube ToS) | No | A panel, not an interview. Last long TV interview: BFMTV, 2026-06-14, 29 min 09 s, `https://www.youtube.com/watch?v=bBDkfoEYk1E`. No TV or radio long interview found since; Ouest-France print interview (Aug 2026). **Gap** |
| Karim Bouamrane | 2026-09-02 | BFMTV | Evening face-to-face with Charles Consigny (BFMTV names no programme on the video page or the YouTube upload, #28) | TV | 26 min 40 s | bfmtv.com `VN-202609020861` (published 21:40, 26 min 39 s) | BFMTV YouTube `https://www.youtube.com/watch?v=kbfL3Xi8mQY` (published 2026-09-02, embeddable) | `tolerated` | No (public YouTube) | Last verified long one: CNews "La grande interview", 2026-06-29, 20 min 46 s, `https://www.youtube.com/watch?v=chF4leeEITk` (embeddable) |
| Bernard Cazeneuve | 2026-09-04 | Utiles colloquium (see D2) | Debate with Xavier Bertrand | In-room | no recording | none (BFMTV extracts only, see D2) | — | — | — | No TV or radio interview found since July. Last long: BFMTV/RMC "Face à Face", 2026-07-20, 18 min 28 s, `https://www.youtube.com/watch?v=t1aa7b1m8aA` (BFMTV copy). **Gap** |
...
| Marine Le Pen | 2026-07-01 (LCI upload date; the catalogue first said 2 July) | LCI | "Le Grand Entretien", Darius Rochebin | TV | 1 h 06 min 13 s | LCI YouTube `https://www.youtube.com/watch?v=hErXRs9wvro` (published 2026-07-01, embeddable). `C6XkrrKR5OA` is the copy on her own channel `@MarineLePenOfficiel` (published 2026-07-02, same duration), not LCI's (#28) | LCI copy `hErXRs9wvro` | `tolerated` | No | 2026-07-07 Journal de 20 heures TF1 (Gilles Bouleau) is the declaration (about 15 min, 5.85 M viewers). Nothing since 27 Aug; rentrée 13 Sept (Hénin-Beaumont) |
| David Lisnard | 2026-09-03 | CNews with Europe 1 | "La Grande Interview", Laurence Ferrari (La Matinale) | TV + radio | 20 min 34 s | `https://www.cnews.fr/emission/2026-09-03/la-grande-interview-david-lisnard-1913297`; Europe 1 page | CNews `@CNEWSofficiel` `https://www.youtube.com/watch?v=qdv76-QYAzY` (20 min 34 s, published 2026-09-03, embeddable); co-broadcaster Europe 1 `6xwZChLDKoQ` (20 min 28 s). `ESHmQJtoEtE` is the copy on his own channel `@david_lisnard`, not CNews's (#28) | `tolerated` | No | |
...
| Jean-Luc Mélenchon | 2026-08-22 | TF1 | Journal de 13 heures, from the AMFIS (Valence) | TV | 6 min 40 s | melenchon.fr entry; copy `https://www.youtube.com/watch?v=5F2dS9aoyrM` (his channel, published 2026-08-22, embeddable) | TF1 Info copy UNVERIFIED | `tolerated` | No | No long interview found since the LCI "interview exceptionnelle sur l'international" of 2026-05-08. His 2 Sept 2026 "conférence sur le moment politique" (Paris, before LFI activists, own stream) is not an interview. **Gap** |
...
| Édouard Philippe | 2026-08-30 | BFMTV | Sunday interview from Tourcoing, at Gérald Darmanin's rentrée (BFMTV names no programme, #28) | TV | 40 min 05 s | BFMTV YouTube `https://www.youtube.com/watch?v=SdDlo7TmYqA` (published 2026-08-30, embeddable). His speech at the same event is a separate upload, `Y-XWFylxL8o`, 44 min 15 s | BFMTV copy `SdDlo7TmYqA` | `tolerated` | No (public YouTube) | Also "C à vous la suite", France 5, 2026-09-04 (talk-show segment); Réunion La 1ère 2026-08-24 |
| Florian Philippot | none found in 2026 | — | Last: Sud Radio Sept 2025 | — | — | — | — | — | — | **Gap** |
| Bruno Retailleau | 2026-08-26 | BFMTV | Evening studio interview, first "rentrée" interview (BFMTV names no programme on the video page, published 21:43, or on YouTube, #28) | TV | 29 min 56 s | BFMTV YouTube `https://www.youtube.com/watch?v=8_qNhqsCk7I` is the full interview, not an extract (published 2026-08-26, embeddable); bfmtv.com `VN-202608260808` carries a 1 min 22 s cut | BFMTV copy `8_qNhqsCk7I` | `tolerated` | No (public YouTube) | Last verified long: CNews "La grande interview", 2026-06-30/07-01, `https://www.youtube.com/watch?v=I73AOEJVU1Y` |
...
| Raphaël Glucksmann | 2026-08-30, 13:20 | France 2 + France Inter | "Franc-jeu", Benjamin Duhamel (first episode of the new Sunday programme) | TV + radio | 38 min 32 s | `https://www.franceinfo.fr/replay-magazine/france-2/franc-jeu/franc-jeu-avec-raphael-glucksmann_8163872.html` | France Télévisions player; franceinfo YouTube copy UNVERIFIED | `tolerated` | No | Also BFMTV/RMC "Face à Face", Apolline de Malherbe, 2026-09-04: RMC live archive `https://www.youtube.com/watch?v=aON3l-inUrY` (24 min 30 s, `@RMC`, embeddable). `YIw00fecnDU` is the 2026-06-02 edition (20 min 20 s), not this one (#28) |
...
| Ségolène Royal | 2026-09-02 | BFMTV / RMC | "Face-à-Face", Apolline de Malherbe | TV + radio | 23 min 10 s (RMC live archive) | RMC `@RMC` `https://www.youtube.com/watch?v=SAfs_QznL7E` (live archive, published 2026-09-02, embeddable); BFMTV cut `-2dGrlG-8rc` (21 min 54 s); her own channel `QVkWJ2p31cI` | RMC copy `SAfs_QznL7E` | `tolerated` | No (public YouTube) | Also "Les 4 Vérités", Télématin, France 2, 2026-08-31 (short) |
...
| Marine Tondelier | 2026-08-22 | LCI | Rentrée interview, Darius Rochebin, from the Écologistes' Journées d'été (Grenoble) | TV | 26 min 57 s | LCI `https://www.youtube.com/watch?v=FZoI-JZaHhw` (26 min 57 s, published 2026-08-22, embeddable, #28); party copy Les Écologistes `https://www.youtube.com/watch?v=pqJ8J3oJm1A` (same duration, published 2026-08-22, embeddable) | Download and embed: LCI copy `FZoI-JZaHhw` | `tolerated` (Source is LCI even when the copy sits on the party channel) | No | Also "8h30 franceinfo", 2026-09-02, 23 min 26 s, Agathe Lambret and Paul Larrouturou, `https://www.franceinfo.fr/replay-radio/8h30-fauvelle-dely/le-8h30-franceinfo-de-marine-tondelier_8144867.html` |

## 5. Open points for the map

1. **Who is a Candidate for the seed.** _Resolved by ADR 0004 (issue #27): primary contenders are Candidates, the seed is every Confrontation (two or more Candidates in one exchange) since 27 August, judged with the roles as known today, and the interview quota is dropped; sections 2.1, 2.2 and 4 keep the old classification as a snapshot. Under the new rule D1, D2 (if recorded) and the primary debates are in the seed, D3 and D4 enter the day Hollande or Villepin is listed, and section 4 is no longer a seed requirement._ Two of the seven MEDEF debaters (Glucksmann, Tondelier) and the whole Libé debate involve primary contenders; the Sens debate pairs a Candidate with an undeclared ex-president. The invariant "balanced coverage across candidates" needs a rule: election-declared only, or declared plus primary contenders, and whether two-person encounters count as "multi-candidate debates". This catalogue flags rather than decides.
...
3. **Replays not located**: resolved on 2026-09-06 from the Mac (#28). All four BFMTV rows (Philippe, Retailleau, Bouamrane, Royal) have a full public YouTube copy on `@BFMTV` or `@RMC`; the Utiles debate (D2) has no recording. What stays open is the name of BFMTV's evening interview slot, which BFMTV itself does not print on the video pages or uploads.
...
- YouTube metadata read with `yt-dlp --dump-json`, logged out, on 2026-09-06 (#28): `rpURHoN54bQ`, `z0gJwsrODEw`, `sp-2F_cTTxA`, `D7vTQp2iM00`, `hErXRs9wvro`, `C6XkrrKR5OA`, `3q7IkWcQ-_w`, `aON3l-inUrY`, `YIw00fecnDU`, `qdv76-QYAzY`, `ESHmQJtoEtE`, `6xwZChLDKoQ`, `5F2dS9aoyrM`, `FZoI-JZaHhw`, `pqJ8J3oJm1A`, `8_qNhqsCk7I`, `kbfL3Xi8mQY`, `SdDlo7TmYqA`, `Y-XWFylxL8o`, `SAfs_QznL7E`, `-2dGrlG-8rc`, `QVkWJ2p31cI`, `56T7EQm-sMs`, `t1aa7b1m8aA`, `bBDkfoEYk1E`; channel listings of `@BFMTV`, `@RMC`, `@LCI`, `@MEDEFtv`, `@CNEWSofficiel`, `@Europe1`, `@publicsenat`, `user/bertrandpancher`
- bfmtv.com video pages `VN-202608260808`, `VN-202609020861`, `VN-202609040381`, `VN-202609040378` (read in a logged-out browser, 2026-09-06)
